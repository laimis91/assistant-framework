...
while round <= 10:
  ...
  1. REVIEW
     - Freeze snapshot/manifest/identity; mutation invalidates. Rebuild persisted v6 under v7 before clean. Load `references/review-batch.md` before batch planning.
