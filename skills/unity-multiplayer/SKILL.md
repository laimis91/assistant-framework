...
Every multiplayer pass should return:
- **Multiplayer Goal** -- Player count, session type, topology needs, and latency tolerance
- **Recommended Architecture** -- Host/client, dedicated server, relay, or hybrid choice with rationale
- **Framework Choice** -- Preferred Unity networking framework and rejected alternatives
- **Implementation Pattern** -- Authority, synchronization, prediction, matchmaking, and persistence notes as applicable
- **Risks and Verification** -- Network risks, test scenarios, and manual checks needed before production use
