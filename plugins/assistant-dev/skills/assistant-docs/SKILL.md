...
- **Evidence** - source files, APIs, commits, or examples used as documentation truth.
- **Coverage** - what the documentation now covers and what remains out of scope.
- **Review needs** - inferred claims, stale areas, conflicts, or open questions needing user confirmation.
