...
source "$P0P4_SUITE_DIR/workflow-runtime-verification-contracts.sh"
source "$P0P4_SUITE_DIR/learning-controller-runtime-contracts.sh"
...
source "$P0P4_SUITE_DIR/slice-review-topology-contracts.sh"
