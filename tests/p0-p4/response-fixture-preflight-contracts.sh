...
test_start "response preflight accepts complete mixed structured and plain fixtures"
...
for preflight_test_mutation in missing empty whitespace malformed multiple exit_failure counted_failure; do
