...
'@
    ...
    Invoke-Contract 'reinstall preserves graph data, custom instructions, and unrelated TOML exactly once' {
        Use-IsolatedEnvironment 'idempotent reinstall' {
            ...
            Assert-Contains $agents 'Do not spawn subagents without explicit authorization; continue safe non-spawn work while authorization is unresolved.' 'Codex guidance is missing the delegation boundary'
